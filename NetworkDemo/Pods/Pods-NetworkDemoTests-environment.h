...
// NetworkLib
#define COCOAPODS_POD_AVAILABLE_NetworkLib
#define COCOAPODS_VERSION_MAJOR_NetworkLib 0
#define COCOAPODS_VERSION_MINOR_NetworkLib 0
#define COCOAPODS_VERSION_PATCH_NetworkLib 1
