#
#  Be sure to run `pod spec lint NetworkLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "roylo" => "joeblack1986@gmail.com" }
  # Or just: s.author    = "roylo"
  # s.authors            = { "roylo" => "joeblack1986@gmail.com" }
  # s.social_media_url   = "http://twitter.com/roylo"
